...
//HGSS_Ui PokedexPlus
const u8 gText_Stats_Buttons[]  = _("{A_BUTTON}CHANGER   {DPAD_UPDOWN}CAPACITES");
...
const u8 gText_Stats_SpAttack[]    = _("ATQ.SP");
const u8 gText_Stats_SpDefense[]    = _("DEF.SP");
...
const u8 gText_Stats_CatchRate[]     = _("CAPTURE{0x5B}: ");
const u8 gText_Stats_CatchRate_Legend[]         = _("LÉGENDAIRE");
const u8 gText_Stats_CatchRate_VeryHard[]       = _("TRÈS DIFFICILE");
...
const u8 gText_Stats_EggCycles[]     = _("PAS POUR ECLOSION :");
...
const u8 gText_Stats_Growthrate[]    = _("CROISSANCE : ");
...
const u8 gText_Stats_MEDIUM_FAST[]   = _("MOYEN-RAPIDE");
const u8 gText_Stats_ERRATIC[]       = _("ERRATIQUE");
const u8 gText_Stats_FLUCTUATING[]   = _("FLUCTUANT");
const u8 gText_Stats_MEDIUM_SLOW[]   = _("MOYEN-LENT");
...
const u8 gText_EVO_FRIENDSHIP[]                     = _("Niv. sup., haute amitié");
const u8 gText_EVO_FRIENDSHIP_DAY[]                 = _("Niv. sup., haute amitié, jour");
const u8 gText_EVO_FRIENDSHIP_NIGHT[]               = _("Niv. sup., haute amitié, nuit");
const u8 gText_EVO_LEVEL[]                          = _("Monte au niv. {STR_VAR_2}");
...
const u8 gText_EVO_LEVEL_ATK_GT_DEF[]               = _("Monte au niv. {STR_VAR_2}, Atq > Déf");
const u8 gText_EVO_LEVEL_ATK_EQ_DEF[]               = _("Monte au niv. {STR_VAR_2}, Atq = Déf");
const u8 gText_EVO_LEVEL_ATK_LT_DEF[]               = _("Monte au niv. {STR_VAR_2}, Atq < Déf");
const u8 gText_EVO_LEVEL_SILCOON[]                  = _("Monte au niv. {STR_VAR_2}, nature Armulys");
const u8 gText_EVO_LEVEL_CASCOON[]                  = _("Monte au niv. {STR_VAR_2}, nature Blindalys");
const u8 gText_EVO_LEVEL_NINJASK[]                  = _("Monte au niv. {STR_VAR_2}");
const u8 gText_EVO_LEVEL_SHEDINJA[]                 = _("Monte au niv. {STR_VAR_2}, équipe<6, 1x POKéBALL");
const u8 gText_EVO_BEAUTY[]                         = _("Niv. sup., haute beauté");
const u8 gText_EVO_LEVEL_FEMALE[]                   = _("Monte au niv. {STR_VAR_2}, femelle");
const u8 gText_EVO_LEVEL_MALE[]                     = _("Monte au niv. {STR_VAR_2}, mâle");
const u8 gText_EVO_LEVEL_NIGHT[]                    = _("Monte au niv. {STR_VAR_2}, nuit");
const u8 gText_EVO_LEVEL_DAY[]                      = _("Monte au niv. {STR_VAR_2}, jour");
const u8 gText_EVO_LEVEL_TIME_MALE[]                = _("Monte au niv. {STR_VAR_2}, ♂, matin (6-9h)");
const u8 gText_EVO_LEVEL_TIME_FEMALE[]              = _("Monte au niv. {STR_VAR_2}, ♀, matin (6-9h)");
const u8 gText_EVO_ITEM_HOLD_DAY[]                  = _("Niv. sup., tient {STR_VAR_2}, jour");
const u8 gText_EVO_ITEM_HOLD_NIGHT[]                = _("Niv. sup., tient {STR_VAR_2}, nuit");
const u8 gText_EVO_ITEM_HOLD[]                      = _("Niv. sup., tient {STR_VAR_2}");
const u8 gText_EVO_MOVE[]                           = _("Niv. sup., connait {STR_VAR_2}");
const u8 gText_EVO_MOVE_TYPE[]                      = _("Niv. sup., connait attaque {STR_VAR_2}");
const u8 gText_EVO_MAPSEC[]                         = _("Monte au niv. {STR_VAR_2}");
...
const u8 gText_EVO_LEVEL_RAIN[]                     = _("Monte au niv. {STR_VAR_2} sous la pluie");
const u8 gText_EVO_SPECIFIC_MON_IN_PARTY[]          = _("Niv. sup. avec {STR_VAR_2} en equipe");
const u8 gText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[]   = _("Niv. sup. avec un type TENEBRES en equipe");
