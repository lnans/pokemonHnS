...
const u8 gText_ProfBirchMatchCallName[] = _("PROF. ORME");
...
const u8 gText_SaveFileErased[] = _("Le fichier de sauvegarde a été effacé\nsuite à une corruption ou un dommage.");
...
const u8 gText_DexHoennDescription[] = _("POKéDEX de la région JOHTO");
...
const u8 gText_HOFDexRating[] = _("POKéMON vus : {STR_VAR_1}!\nPOKéMON possédés : {STR_VAR_2}!\pÉvaluation du POKéDEX par le PROF. SEKO!\pPROF. SEKO : Voyons voir…\p");
const u8 gText_HOFDexSaving[] = _("SAUVEGARDE…\nN'ÉTEIGNEZ PAS LA CONSOLE.");
...
const u8 gText_OakTalk_Clefairy[] = _(
    "MARY: Ce soir dans PARLONS POKéMON,\n"
    "un instant rare au clair de lune !\l"
    "CHEN: Aujourd'hui, focus sur\l"
    "le mystérieux MÉLOFÉE !\l"
    "Des Dresseurs disent qu'ils\l"
    "se rassemblent au MONT SELENITE\l"
    "lors des nuits de pleine lune.\l"
    "MARY: Ils DANSENT en rond !\l"
    "Bizarre, mais trop mignon !\l"
    "CHEN: Un mystère éternel,\l"
    "un spectacle à voir absolument !\l"
    "MARY: Ne ratez pas ça !\l"
    "Prenez un appareil photo !{PAUSE_UNTIL_PRESS}");

const u8 gText_OakTalk_Lapras[] = _(
    "MARY: Un doux géant est à\n"
    "l'honneur aujourd'hui !\l"
    "CHEN: Le ferry des océans,\l"
    "notre cher LOKHLASS !\l"
    "Aperçu dans les CAVES JUMELLES,\l"
    "mais seulement en soirée.\l"
    "MARY: Si rare et paisible !\l"
    "Et en plus, il chante !\l"
    "CHEN: On dit que son chant\l"
    "apaise l'âme de la mer.\l"
    "MARY: On t'aime, LOKHLASS !\l"
    "Ne change jamais !{PAUSE_UNTIL_PRESS}");

const u8 gText_OakTalk_Ampharos[] = _(
    "MARY: Bon retour à tous !\n"
    "C'est l'heure de PARLONS POKéMON !\l"
    "CHEN: Mettons en lumière\l"
    "notre ami PHARAMP !\l"
    "Sa queue brillante perce le\l"
    "brouillard pour guider les perdus.\l"
    "MARY: Puissant, élégant,\l"
    "et très amical !\l"
    "CHEN: Il est au cœur de\l"
    "nombreuses histoires de phares !\l"
    "MARY: D'autres récits bientôt !\l"
    "Ne zappez pas !{PAUSE_UNTIL_PRESS}");

const u8 gText_OakTalk_Sudowoodo[] = _(
    "MARY: Prochain sujet étrange\n"
    "sur la ROUTE 36...\l"
    "CHEN: SIMULARBRE ! Il ressemble\l"
    "à un arbre, mais n'en est pas un !\l"
    "Il bloque la route et ne bouge\l"
    "pas sans un peu d'eau.\l"
    "MARY: Les Dresseurs disent\l"
    "qu'il réagit à un ARROSOIR !\l"
    "CHEN: Ce n'est pas un buisson,\l"
    "mais un ROC déguisé !\l"
    "MARY: Ne vous laissez pas piéger !\l"
    "Arrosez-le !{PAUSE_UNTIL_PRESS}");

const u8 gText_OakTalk_RedGyarados[] = _(
    "MARY: Une histoire choc\n"
    "nous vient de JOHTO !\l"
    "CHEN: Un LÉVIATOR ROUGE\l"
    "aperçu au LAC COLÈRE !\l"
    "Contrairement aux bleus,\l"
    "celui-ci est rouge vif !\l"
    "MARY: Certains parlent\l"
    "d'ondes radio étranges !\l"
    "CHEN: Une évolution mystérieuse,\l"
    "peut-être artificielle...\l"
    "MARY: Quelle qu'en soit la cause,\l"
    "il fait des vagues !{PAUSE_UNTIL_PRESS}");

const u8 gText_OakTalk_Unown[] = _(
    "MARY: Avez-vous visité les\n"
    "RUINES D'ALPHA ? Frissons garantis !\l"
    "CHEN: Des symboles étranges\l"
    "tapissent les murs anciens.\l"
    "À l'intérieur vivent les ZARBI,\l"
    "chacun en forme de lettre !\l"
    "MARY: Ils forment des mots ?\l"
    "Ou juste pour nous effrayer ?\l"
    "CHEN: Un vrai mystère de la nature,\l"
    "encore irrésolu aujourd'hui.\l"
    "MARY: Dites-nous votre avis !{PAUSE_UNTIL_PRESS}");

const u8 gText_OakTalk_Snubbull[] = _(
    "MARY: Les habitants de DOUBLONVILLE\n"
    "cherchent partout !\l"
    "CHEN: Un SNUBBULL s'est enfui\l"
    "et court toujours !\l"
    "D'ordinaire timide et délicat,\l"
    "il a été vu près de la gare.\l"
    "MARY: Il cherche peut-être l'amour,\l"
    "ou juste l'aventure !\l"
    "CHEN: Quoi qu'il en soit,\l"
    "ouvrez l'œil et tenez la laisse !\l"
    "MARY: SNUBBULL, rentre à la maison !\l"
    "Tu nous manques !{PAUSE_UNTIL_PRESS}");

const u8 gText_OakTalk_Slowpoke[] = _(
    "MARY: Grandes nouvelles de\n"
    "ECORCIA cette semaine !\l"
    "CHEN: Les RAMOLOSS sont revenus\l"
    "au puits après la crise !\l"
    "La TEAM ROCKET leur coupait\l"
    "la queue, c'était horrible !\l"
    "MARY: Mais un jeune Dresseur\l"
    "courageux les a arrêtés !\l"
    "CHEN: Les RAMOLOSS sont en sécurité\l"
    "et dorment paisiblement.\l"
    "MARY: Justice rendue,\l"
    "et sieste retrouvée !{PAUSE_UNTIL_PRESS}");

const u8 gText_OakTalk_LavenderTower[] = _(
    "MARY: La TOUR de LAVANVILLE\n"
    "a changé de musique !\l"
    "CHEN: L'ancienne tour fantôme\l"
    "est devenue une STATION RADIO !\l"
    "Certains disent qu'elle semble\l"
    "encore... inquiétante.\l"
    "MARY: J'ai juré voir un SPECTRUM\l"
    "près du micro !\l"
    "CHEN: Des interférences...\l"
    "ou des esprits ?\l"
    "MARY: En tout cas, bonne musique !\l"
    "Enfin... je crois !{PAUSE_UNTIL_PRESS}");

const u8 gText_OakTalk_TentacruelWhirl[] = _(
    "MARY: Étranges nouvelles des\n"
    "TOURB'ÎLES aujourd'hui !\l"
    "CHEN: Des TENTACRUEL ont été vus\l"
    "autour des entrées de grottes !\l"
    "Ils sont immenses et semblent\l"
    "très territoriaux.\l"
    "MARY: Ils bloquent le passage\l"
    "sans attaquer.\l"
    "CHEN: Comme s'ils gardaient\l"
    "quelque chose sous les flots.\l"
    "MARY: Que cachent-ils ?\l"
    "Ou que protègent-ils ?{PAUSE_UNTIL_PRESS}");


const u8 gText_RocketRadio[] = _("... ... Hem, nous sommes la\nTEAM ROCKET!\lAprès trois ans de préparation,\lnous sommes revenus de nos cendres!\lGIOVANNI! Vous nous entendez?\lNous l'avons fait!\lOù est notre boss?\lNous écoute-t-il?{PAUSE_UNTIL_PRESS}");
const u8 gText_RadioNoSignal[] = _("Pas de signal ici, essayez\nailleurs.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_SoldOut[] = _("Désolé, cet objet est épuisé.\p");
...
const u8 gText_YouAlreadyHaveThis[] = _("Vous avez déjà cet objet.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_ThrowInPremierBalls[] = _("Je mets quelques HONOR BALLS en plus.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_CantTradeWithTrainer[] = _("Vous ne pouvez pas échanger\navec ce DRESSEUR maintenant.");
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("Ce n'est pas le type de POKéMON\nque l'autre DRESSEUR veut.");
...
const u8 gText_EggReadyToHatch_Nuzlocke[] = _("Prêt à éclore, mais bloqué\npar la rencontre Nuzlocke !");
const u8 gText_HMMovesCantBeForgotten2[] = _("Impossible d'oublier les\ncapacités CS maintenant.");
const u8 gText_XNatureMetAtYZ[] = _(
    "{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05}{DYNAMIC 0x06}{DYNAMIC 0x07} de nature,\n"
    "rencontré au {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01},\n{DYNAMIC 0x00}{DYNAMIC 0x04}{DYNAMIC 0x01}.");

const u8 gText_XNatureHatchedAtYZ[] = _(
    "{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05}{DYNAMIC 0x06}{DYNAMIC 0x07} de nature,\n"
    "a éclos au {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01},\n{DYNAMIC 0x00}{DYNAMIC 0x04}{DYNAMIC 0x01}.");
...
const u8 gText_XNatureFatefulEncounter[] = _(
    "{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05}{DYNAMIC 0x06}{DYNAMIC 0x07} de nature,\n"
    "obtenu lors d'un évènement\nspécial au {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01}.");

const u8 gText_XNatureProbablyMetAt[] = _(
    "{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05}{DYNAMIC 0x06}{DYNAMIC 0x07} de nature,\n"
    "probablement rencontré au {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01},\n{DYNAMIC 0x00}{DYNAMIC 0x04}{DYNAMIC 0x01}.");

const u8 gText_XNature[] = _("{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05}{DYNAMIC 0x06}{DYNAMIC 0x07} de nature");

const u8 gText_XNatureMetSomewhereAt[] = _(
    "{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05}{DYNAMIC 0x06}{DYNAMIC 0x07} de nature,\n"
    "rencontré quelque part {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01}.");

const u8 gText_XNatureHatchedSomewhereAt[] = _(
    "{DYNAMIC 0x00}{DYNAMIC 0x02}{DYNAMIC 0x01}{DYNAMIC 0x05}{DYNAMIC 0x06}{DYNAMIC 0x07} de nature,\n"
    "a éclos quelque part\nau {LV_2}{DYNAMIC 0x00}{DYNAMIC 0x03}{DYNAMIC 0x01}.");
...
const u8 gText_RegirockDollAndPrice[] = _("POUP. REGIROCK  9000 JET.");
const u8 gText_RegiceDollAndPrice[] = _("POUP. REGICE    9000 JET.");
const u8 gText_RegisteelDollAndPrice[] = _("POUP. REGISTEEL 9000 JET.");
const u8 gText_50CoinsAndPrice[] = _  ("50 JETONS{CLEAR_TO 0x4F}500¥");
const u8 gText_500CoinsAndPrice[] = _ ("500 JETONS{CLEAR_TO 0x4F}5000¥");
const u8 gText_1000CoinsAndPrice[] = _("1000 JETONS{CLEAR_TO 0x4F}10000¥");
const u8 gText_2500CoinsAndPrice[] = _("2500 JETONS{CLEAR_TO 0x4F}25000¥");
const u8 gText_5000CoinsAndPrice[] = _("5000 JETONS{CLEAR_TO 0x4F}50000¥");
...
const u8 gText_Olivine[] = _("OLIVILLE");
const u8 gText_ClawFossil[] = _("FOSS. GRIFFE");
const u8 gText_RootFossil[] = _("FOSS. RACINE");
const u8 gText_HelixFossil[] = _("FOSS. NAUTILE");
const u8 gText_DomeFossil[] = _("FOSS. DÔME");
...
const u8 gText_NuzlockeFainted[] = _("{PKMN} est K.O. en Nuzlocke !");
const u8 gText_FaintedForever[] = _("{PKMN} est K.O. pour toujours !");
...
const u8 gText_CheckMapOfHoenn[] = _("Carte de la région JOHTO.");
...
const u8 gText_CheckObtainedRadio[] = _("Écouter la RADIO.");
...
extern const u8 gText_PokenavMap_CancelOnly[] = _("{B_BUTTON} Retour");
...
const u8 gText_EntireTextCantBeDeleted[] = _("Le texte complet ne peut pas être effacé.");
...
const u8 gText_TreeckoDoll48BP[] = _("POUPEE ARCKO{CLEAR_TO 0x5E}48BP");
const u8 gText_TorchicDoll48BP[] = _("POUP. POUSSIFEU{CLEAR_TO 0x5E}48BP");
const u8 gText_MudkipDoll48BP[] = _("POUPEE GOBOU{CLEAR_TO 0x5E}48BP");
...
const u8 gText_FrenzyPlant64BP[] = _("VEGE-ATTAQUE{CLEAR_TO 0x4E}64BP");
const u8 gText_BlastBurn64BP[] = _("RAFALE FEU{CLEAR_TO 0x4E}64BP");
const u8 gText_HydroCannon64BP[] = _("HYDROBLAST{CLEAR_TO 0x4E}64BP");
const u8 gText_PkmnFainted_FldPsn[] = _("{STR_VAR_1} est K.O…\p\n");
const u8 gText_PkmnSurvived_FldPsn[] = _("{STR_VAR_1} a survécu au poison.\nLe poison s'est dissipé!\p");
...
const u8 gText_WinsStraight[] = _("V/{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_1}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}  D'AFFILEE/{COLOR RED}{SHADOW LIGHT_RED}{STR_VAR_2}");
...
const u8 gText_Easy[] = _("FACILE");
const u8 gText_Hard[] = _("DIFFICILE");
const u8 gText_Modern[] = _("MODERNE");
const u8 gText_Classic[] = _("CLASSIQUE");
//HnS texts
...
const u8 gText_LoveBall[] =     _("LOVE    / PÊCHA  / (FEE/PSY)");
const u8 gText_Lure[] =         _("APPÂT   / FRAIVE / (EAU/DRG)");
const u8 gText_FriendBall[] =   _("COPAIN / CERIZ  / (INS/PLN)");
const u8 gText_Heavy[] =        _("MASSE   / ORAN   / (RCH/SOL/ACI)");
const u8 gText_Moon[] =         _("LUNE    / MARON  / (TNB/SPC/PSN)");
const u8 gText_Fast[] =         _("SPEED   / WILLIA / (ELC/CBT/FEU)");
const u8 gText_LevelBall[] =    _("NIVEAU / KIKA   / (NRM/VOL/GLC)");

const u8 gText_Abra[] = _("ABRA{CLEAR_TO 0x40}120 JETONS");
const u8 gText_Clefairy[] = _("MELOFEE{CLEAR_TO 0x40}500 JETONS");
const u8 gText_Munchlax[] = _("GOINFREX{CLEAR_TO 0x40}2800 JETONS");
const u8 gText_Dratini[] = _("MINIDRACO{CLEAR_TO 0x40}5500 JETONS");
const u8 gText_Porygon[] = _("PORYGON{CLEAR_TO 0x40}6500 JETONS");

const u8 gText_Pal[] = _("Pal");
const u8 gText_Underling[] = _("Assistant");

const u8 gText_Strategy[] = _("Stratégie");
const u8 gText_Training[] = _("Entraînement");
const u8 gText_Cheating[] = _("Triche");

const u8 gText_WeakPerson[] = _("Personne faible");
const u8 gText_ToughPerson[] = _("Personne forte");
const u8 gText_Anybody[] = _("N'importe qui");

const u8 gText_Love2[] = _("Amour");
const u8 gText_Violence[] = _("Violence");
const u8 gText_Knowledge[] = _("Connaissance");

const u8 gText_Tough3[] = _("Fort");
const u8 gText_Weak[] = _("Faible");
const u8 gText_Both[] = _("Les deux");

const u8 gText_BlueStone[] = _("PIERRE BLEUE");
const u8 gText_GreenStone[] = _("PIERRE VERTE");
const u8 gText_RedStone[] = _("PIERRE ROUGE");
...
ALIGNED(4) const u8 gText_ReadyPickBerry[] = _("Prêt pour le BROYEUR DE BAIES ?\nVeuillez choisir une BAIE à utiliser.\p");
ALIGNED(4) const u8 gText_WaitForAllChooseBerry[] = _("Veuillez patienter pendant que chaque\njoueur choisit une BAIE.");
ALIGNED(4) const u8 gText_EndedWithXUnitsPowder[] = _("{PAUSE_MUSIC}{PLAY_BGM MUS_LEVEL_UP}Vous obtenez {STR_VAR_1} unités de\nPOUDRE DE BAIE soyeuse.{RESUME_MUSIC}\pVotre total de POUDRE DE BAIE est de\n{STR_VAR_2}.\p");
ALIGNED(4) const u8 gText_RecordingGameResults[] = _("Enregistrement des résultats dans\nla sauvegarde.\lVeuillez patienter.");
ALIGNED(4) const u8 gText_PlayBerryCrushAgain[] = _("Voulez-vous rejouer au BROYEUR DE BAIES ?");
ALIGNED(4) const u8 gText_YouHaveNoBerries[] = _("Vous n'avez pas de BAIES.\nLa partie sera annulée.");
ALIGNED(4) const u8 gText_MemberDroppedOut[] = _("Un joueur a quitté la partie.\nLa partie sera annulée.");
ALIGNED(4) const u8 gText_TimesUpNoGoodPowder[] = _("Temps écoulé.\pLa POUDRE DE BAIE n'a pas pu\nêtre obtenue…\p");
...
ALIGNED(4) const u8 gText_PressingSpeed[] = _("Vitesse de pressage:");
...
ALIGNED(4) const u8 gText_PressesRankings[] = _("Classement des pressions");
ALIGNED(4) const u8 gText_CrushingResults[] = _("Résultats du broyage");
ALIGNED(4) const u8 gText_NeatnessRankings[] = _("Classement de propreté");
ALIGNED(4) const u8 gText_CoopRankings[] = _("Classement de coopération");
ALIGNED(4) const u8 gText_PressingPowerRankings[] = _("Classement de puissance de pressage");
...
ALIGNED(4) const u8 gText_FrontierFacilityFloorsCleared[] = _("Étages: {STR_VAR_2}");
...
const u8 gText_Autorun[] = _("AUTO");
const u8 gText_Sound[] = _("SON");
const u8 gText_Frame[] = _("FENETRE");
const u8 gText_OptionMenuCancel[] = _("RETOUR");
const u8 gText_FollowerEnable[] = _("{PKMN} SUIVEUR");  //tx_optionsPlus
const u8 gText_AutorunEnable[] = _("COURSE AUTO");  //tx_optionsPlus
const u8 gText_OptionMatchCalls[] = _("APPELS COMBATS");  //tx_optionsPlus
const u8 gText_OptionMenuSave[] = _("SAUVEGARDER");  //tx_optionsPlus
const u8 gText_OptionStyle[] = _("SPLIT");  //tx_optionsPlus
const u8 gText_OptionDifficulty[] = _("DIFFICULTE");  //tx_optionsPlus
const u8 gText_ButtonMode[] = _("BOUTONS");
...
ALIGNED(4) const u8 gText_WonderCardsInPossession[] = _("Lire les CARTES MIRACLE en votre\npossession.");
ALIGNED(4) const u8 gText_ReadNewsThatArrived[] = _("Lire les INFOS MIRACLE reçues.");
ALIGNED(4) const u8 gText_ReturnToTitle[] = _("Retour à l'écran titre.");
ALIGNED(4) const u8 gText_DontHaveCardNewOneInput[] = _("Vous n'avez pas de CARTE MIRACLE,\nune nouvelle CARTE sera saisie.");
ALIGNED(4) const u8 gText_DontHaveNewsNewOneInput[] = _("Vous n'avez pas d'INFOS MIRACLE,\nde nouvelles INFOS seront saisies.");
ALIGNED(4) const u8 gText_WhereShouldCardBeAccessed[] = _("Où accéder à la CARTE MIRACLE?");
ALIGNED(4) const u8 gText_WhereShouldNewsBeAccessed[] = _("Où accéder aux INFOS MIRACLE?");
ALIGNED(4) const u8 gText_CommunicationStandbyBButtonCancel[] = _("En attente de communication...\nTouche B : Annuler"); // Unused
...
ALIGNED(4) const u8 gText_ThrowAwayWonderCard[] = _("Jeter la CARTE MIRACLE\net saisir une nouvelle CARTE?");
ALIGNED(4) const u8 gText_HaventReceivedCardsGift[] = _("Vous n'avez pas encore reçu le cadeau\nde la CARTE. Saisir une nouvelle CARTE quand même?");
...
ALIGNED(4) const u8 gText_NewTrainerReceived[] = _("Un nouvel ENTRAÎNEUR est arrivé.");
...
ALIGNED(4) const u8 gText_RecordUploadedViaWireless[] = _("Votre record a été envoyé via\nCOMMUNICATION SANS FIL.");
...
ALIGNED(4) const u8 gText_CantSendGiftToTrainer[] = _("Vous ne pouvez pas envoyer de CADEAU MYSTERE\nà ce DRESSEUR.");
ALIGNED(4) const u8 gText_IfThrowAwayCardEventWontHappen[] = _("Si vous jetez la CARTE,\nl'évènement ne se produira pas. OK?");
ALIGNED(4) const u8 gText_OkayToDiscardNews[] = _("Êtes-vous sûr(e) de vouloir supprimer\ncette INFO MIRACLE?");
ALIGNED(4) const u8 gText_HaventReceivedGiftOkayToDiscard[] = _("Vous n'avez pas reçu le\nCADEAU. Supprimer quand même?");
...
ALIGNED(4) const u8 gText_MysteryGift[] = _("CADEAU MYSTERE");
ALIGNED(4) const u8 gText_PickOKExit[] = _("{DPAD_UPDOWN}CHOIX {A_BUTTON}OK {B_BUTTON}QUITTER");
ALIGNED(4) const u8 gText_PickOKCancel[] = _("{DPAD_UPDOWN}CHOIX {A_BUTTON}OK {B_BUTTON}ANNULER");
const u8 gText_PlayersBattleResults[] = _("RÉSULTATS DE COMBAT DE {PLAYER}");
const u8 gText_TotalRecordWLD[] = _("TOTAL V:{STR_VAR_1} D:{STR_VAR_2} N:{STR_VAR_3}");
...
const u8 gText_ReelTimeHelp[] = _("REEL TIME\nC'est votre chance de viser\net de marquer des points!\nReel Time continue pendant le\nnombre de tours attribués.\nTout se termine sur un Gros Bonus.");
const u8 gDaycareText_GetAlongVeryWell[] = _("Ils semblent très bien\ns'entendre.");
const u8 gDaycareText_GetAlong[] = _("Ils semblent bien\ns'entendre.");
const u8 gDaycareText_DontLikeOther[] = _("Ils ne semblent pas trop\ns'apprécier.");
...
const u8 gText_TimeBoard[] = _("TABLEAU DES TEMPS");
const u8 gText_TimeCleared[] = _("TEMPS TERMINÉ ");
...
const u8 gText_NormanMatchCallDesc[] = _("HOMME FIABLE");
const u8 gText_MomMatchCallDesc[] = _("CALME & GENTILLE");
const u8 gText_BaobaMatchCallDesc[] = _("GARDIEN DU SAFARI");
const u8 gText_WallyMatchCallDesc[] = _("AMOUREUX DES {PKMN}");
...
const u8 gText_BrawlyMatchCallDesc[] = _("LE GROS COUP");
...
const u8 gText_AshQty[] = _("Quantité de cendre :\n{STR_VAR_1}{PAUSE_UNTIL_PRESS}");

// Exp. Share
const u8 gText_ExpShareOn[] = _("Le Multi Exp. est activé.\pL'équipe gagne maintenant une partie\ndes Points d'Expérience.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpShareOff[] = _("Le Multi Exp. est désactivé.\pL'équipe ne gagnera plus une partie\ndes Points d'Expérience.{PAUSE_UNTIL_PRESS}");
// Inf. Repel
const u8 gText_infiniteRepelOn[] = _("Repousse inf. activé.{PAUSE_UNTIL_PRESS}");
const u8 gText_infiniteRepelOff[] = _("Repousse inf. désactivé.{PAUSE_UNTIL_PRESS}");
// Inf. Candies
const u8 gText_infiniteCandies[] = _("Vous avez obtenu 999 SUPER\nBONBONS!{PAUSE_UNTIL_PRESS}");
const u8 gText_HealingHeart[] = _("Le doux COEUR SOIN\na totalement soigné votre équipe!{PAUSE 120}{WAIT_SE}");

//tx_randomizer_and_challenges
const u8 gText_NuzlockeCantThrowPokeBallRoute[]             = _("Vous avez déjà utilisé votre rencontre\npour cette zone!{PAUSE_UNTIL_PRESS}");
const u8 gText_NuzlockeCantThrowPokeBallSpeciesClause[]     = _("Vous avez déjà capturé un POKéMON\nsur cette lignée évolutive!{PAUSE_UNTIL_PRESS}");
const u8 gText_NuzlockeCantThrowPokeBallAlreadyCaught[]     = _("Vous avez déjà capturé ce POKéMON!{PAUSE_UNTIL_PRESS}");
const u8 gText_OneTypeChallengeCantThrowPokeBall[]          = _("Défi Monotype actif, capture\nbloquée!{PAUSE_UNTIL_PRESS}");
const u8 gText_BattleRules_NoItems_Player[]                 = _("Règles compétitives!\nAucun objet en combat!{PAUSE_UNTIL_PRESS}");


//HGSS_Ui PokedexPlus
const u8 gText_Stats_Buttons[]  = _("{A_BUTTON}CHANG. {DPAD_UPDOWN}CAPA.");
const u8 gText_Stats_Buttons_Decapped[]  = _("{A_BUTTON}Changer   {DPAD_UPDOWN}Capacites");
const u8 gText_Stats_HP[]       = _("PV");
const u8 gText_Stats_Attack[]   = _("ATQ");
const u8 gText_Stats_Defense[]  = _("DEF");
const u8 gText_Stats_Speed[]    = _("VIT");
const u8 gText_Stats_SpAttack[]    = _("ATQ.S");
const u8 gText_Stats_SpDefense[]    = _("DEF.S");
...
const u8 gText_Stats_CatchRate[]     = _("CAPTURE:");
const u8 gText_Stats_CatchRate_Legend[]         = _("LEGEND.");
const u8 gText_Stats_CatchRate_VeryHard[]       = _("TRES DIFF");
const u8 gText_Stats_CatchRate_Difficult[]      = _("DIFFICILE");
const u8 gText_Stats_CatchRate_Medium[]         = _("MOYEN");
const u8 gText_Stats_CatchRate_Relaxed[]        = _("DÉTENDU");
const u8 gText_Stats_CatchRate_Easy[]           = _("FACILE");
const u8 gText_Stats_ExpYield[]      = _("EXP OBTENUE : ");
const u8 gText_Stats_EggCycles[]     = _("PAS ECLOS. :");
...
const u8 gText_Stats_Growthrate[]    = _("CROISS.:");
const u8 gText_Stats_Friendship[]    = _("AMITIÉ :");
...
const u8 gText_Stats_MEDIUM_FAST[]   = _("MOY.RAPID");
const u8 gText_Stats_ERRATIC[]       = _("ERRATIQUE");
const u8 gText_Stats_FLUCTUATING[]   = _("FLUCTUANT");
const u8 gText_Stats_MEDIUM_SLOW[]   = _("MOY.LENT");
const u8 gText_Stats_FAST[]          = _("RAPIDE");
const u8 gText_Stats_SLOW[]          = _("LENT");
const u8 gText_Stats_ContestHeart[]  = _("C");
const u8 gText_Stats_Minus[] = _("-");
const u8 gText_Stats_eggGroup[]             = _("GROUPE OEUF :");
const u8 gText_Stats_eggGroup_Groups[]      = _("{STR_VAR_1}/{STR_VAR_2}");
const u8 gText_Stats_eggGroup_MONSTER[]     = _("MONSTRE");
const u8 gText_Stats_eggGroup_WATER_1[]     = _("EAU {CIRCLE_1}");
const u8 gText_Stats_eggGroup_BUG[]         = _("INSECTE");
const u8 gText_Stats_eggGroup_FLYING[]      = _("VOL");
const u8 gText_Stats_eggGroup_FIELD[]       = _("SOL");
const u8 gText_Stats_eggGroup_FAIRY[]       = _("FEE");
const u8 gText_Stats_eggGroup_GRASS[]       = _("PLANTE");
const u8 gText_Stats_eggGroup_HUMAN_LIKE[]  = _("HUMANOIDE");
const u8 gText_Stats_eggGroup_WATER_3[]     = _("EAU {CIRCLE_3}");
const u8 gText_Stats_eggGroup_MINERAL[]     = _("MINERAL");
const u8 gText_Stats_eggGroup_AMORPHOUS[]   = _("AMORPHE");
const u8 gText_Stats_eggGroup_WATER_2[]     = _("EAU {CIRCLE_2}");
const u8 gText_Stats_eggGroup_DITTO[]       = _("METAMORPH");
const u8 gText_Stats_eggGroup_DRAGON[]      = _("DRAGON");
const u8 gText_Stats_eggGroup_UNDISCOVERED[]= _("---");
const u8 gText_Dex_SEEN[]   = _("VU");
const u8 gText_Dex_OWN[]    = _("OBTENU");

const u8 gText_EVO_Buttons[]                        = _("{DPAD_UPDOWN}Évos  {A_BUTTON}Voir");
const u8 gText_EVO_Buttons_Decapped[]               = _("{DPAD_UPDOWN}Évos  {A_BUTTON}Voir");
const u8 gText_EVO_Buttons_PE[]                     = _("{DPAD_UPDOWN}Évos  {A_BUTTON}Voir  {START_BUTTON}Formes");
const u8 gText_EVO_Buttons_Decapped_PE[]            = _("{DPAD_UPDOWN}Evos  {A_BUTTON}Voir  {START_BUTTON}Orig.");
const u8 gText_EVO_Name[]                           = _("{STR_VAR_3}:");
const u8 gText_EVO_PreEvo[]                         = _("{STR_VAR_1} évolue depuis {STR_VAR_2}");
const u8 gText_EVO_PreEvo_PE_Mega[]                 = _("{STR_VAR_1} méga-évolue avec {STR_VAR_2}");
const u8 gText_EVO_FRIENDSHIP[]                     = _("Montée de niveau, haute amitié");
const u8 gText_EVO_FRIENDSHIP_DAY[]                 = _("Montée de niveau, haute amitié, jour");
const u8 gText_EVO_FRIENDSHIP_NIGHT[]               = _("Montée de niveau, haute amitié, nuit");
const u8 gText_EVO_LEVEL[]                          = _("Monter au niv. {STR_VAR_2}");
const u8 gText_EVO_TRADE[]                          = _("Échange");
const u8 gText_EVO_TRADE_ITEM[]                     = _("Échange avec {STR_VAR_2} tenu");
const u8 gText_EVO_ITEM[]                           = _("Utilisation de {STR_VAR_2}");
const u8 gText_EVO_LEVEL_ATK_GT_DEF[]               = _("Monter au niv. {STR_VAR_2}, Atq > Déf");
const u8 gText_EVO_LEVEL_ATK_EQ_DEF[]               = _("Monter au niv. {STR_VAR_2}, Atq = Déf");
const u8 gText_EVO_LEVEL_ATK_LT_DEF[]               = _("Monter au niv. {STR_VAR_2}, Atq < Déf");
const u8 gText_EVO_LEVEL_SILCOON[]                  = _("Monter au niv. {STR_VAR_2}, nature Armulys");
const u8 gText_EVO_LEVEL_CASCOON[]                  = _("Monter au niv. {STR_VAR_2}, nature Blindalys");
const u8 gText_EVO_LEVEL_NINJASK[]                  = _("Monter au niv. {STR_VAR_2}");
const u8 gText_EVO_LEVEL_SHEDINJA[]                 = _("Monter au niv. {STR_VAR_2}, équipe<6, 1x POKéBALL");
const u8 gText_EVO_BEAUTY[]                         = _("Montée de niveau, haute beauté");
const u8 gText_EVO_LEVEL_FEMALE[]                   = _("Monter au niv. {STR_VAR_2}, femelle");
const u8 gText_EVO_LEVEL_MALE[]                     = _("Monter au niv. {STR_VAR_2}, mâle");
const u8 gText_EVO_LEVEL_NIGHT[]                    = _("Monter au niv. {STR_VAR_2}, nuit");
const u8 gText_EVO_LEVEL_DAY[]                      = _("Monter au niv. {STR_VAR_2}, jour");
const u8 gText_EVO_LEVEL_TIME_MALE[]                = _("Monter au niv. {STR_VAR_2}, ♂, matin (6-9h)");
const u8 gText_EVO_LEVEL_TIME_FEMALE[]              = _("Monter au niv. {STR_VAR_2}, ♀, matin (6-9h)");
const u8 gText_EVO_ITEM_HOLD_DAY[]                  = _("Montée de niveau, tient {STR_VAR_2}, jour");
const u8 gText_EVO_ITEM_HOLD_NIGHT[]                = _("Montée de niveau, tient {STR_VAR_2}, nuit");
const u8 gText_EVO_ITEM_HOLD[]                      = _("Montée de niveau, tient {STR_VAR_2}");
const u8 gText_EVO_MOVE[]                           = _("Montée de niveau, connait {STR_VAR_2}");
const u8 gText_EVO_MOVE_TYPE[]                      = _("Montée de niveau, connait attaque {STR_VAR_2}");
const u8 gText_EVO_MAPSEC[]                         = _("Monter au niv. {STR_VAR_2}");
const u8 gText_EVO_ITEM_MALE[]                      = _("{STR_VAR_2} utilisé sur un mâle");
const u8 gText_EVO_ITEM_FEMALE[]                    = _("{STR_VAR_2} utilisé sur une femelle");
const u8 gText_EVO_LEVEL_RAIN[]                     = _("Monter au niv. {STR_VAR_2} sous la pluie");
const u8 gText_EVO_SPECIFIC_MON_IN_PARTY[]          = _("Montée de niveau avec {STR_VAR_2} en equipe");
const u8 gText_EVO_LEVEL_DARK_TYPE_MON_IN_PARTY[]   = _("Montée de niveau avec un type TENEBRES en equipe");
const u8 gText_EVO_TRADE_SPECIFIC_MON[]             = _("Échange contre {STR_VAR_2}");
const u8 gText_EVO_SPECIFIC_MAP[]                   = _("Monte de niveau à {STR_VAR_2}");
const u8 gText_EVO_UNKNOWN[]                        = _("Méthode inconnue");
const u8 gText_EVO_NONE[]                           = _("{STR_VAR_1} n'a pas d'évolution.");
const u8 gText_EVO_LEVEL_LOCATION[]                 = _("Monte de niveau à {STR_VAR_2}");

const u8 gText_FORMS_Buttons_PE[]                   = _("{A_BUTTON}FORMES  {START_BUTTON}EVOS");
const u8 gText_FORMS_Buttons_Decapped_PE[]          = _("{START_BUTTON}Evos");
const u8 gText_FORMS_Buttons_Submenu_PE[]           = _("{DPAD_NONE}FORMES {A_BUTTON}VOIR {START_BUTTON}EVOS");
const u8 gText_FORMS_Buttons_Submenu_Decapped_PE[]  = _("{START_BUTTON}Evos");
const u8 gText_FORMS_NONE[]                         = _("{STR_VAR_1} n'a pas de formes alternatives.");
