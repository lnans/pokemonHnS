...
const struct RegionMapLocation gRegionMapEntries_Johto[] = {
    ...
    [MAPSEC_EMBEDDED_TOWER] = { 1, 10, 1, 1, sMapName_TOUR_ENFOUIE},
    [MAPSEC_OLIVINE_LIGHTHOUSE] = { 3, 6, 1, 1, sMapName_PHARE},
    [MAPSEC_TRAINER_HILL] = { 2, 5, 1, 1, sMapName_MONT_DRESSEURS},
    [MAPSEC_BATTLE_FRONTIER] = { 1, 17, 1, 1, sMapName_ZONE_DE_COMBAT},
